...
export default function AdminStoresPage() {
  ...
  const handleAddStore = async (e: React.FormEvent) => {
    ...
    setAdding(true);
    try {
      const res = await fetchWithAuth(`https://eyevengers-web.onrender.com/api/admin/stores`, {
        method: 'POST',
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      await fetchWithAuth(`https://eyevengers-web.onrender.com/api/admin/stores/${id}`, { method: 'DELETE' });
