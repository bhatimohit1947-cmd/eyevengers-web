      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <form onSubmit={handleSave} className="p-6 flex flex-col gap-6">
          ...
          <div className="border-b border-gray-100 pb-4 mb-2 mt-6">
            ...
            <p className="text-sm text-gray-500">Configure chat support and social links</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">WhatsApp Number (For Chat)</label>
              <input 
                type="text" 
                placeholder="e.g. 9351009906"
